  ...
  Widget _buildActionCell(String name, String path) {
    return Container(
      ...
      child: InkWell(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.image, color: pink, size: 24), SizedBox(width: 8), Text("Open", style: TextStyle(color: const Color.fromARGB(255, 172, 45, 106), fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontSize: 16))]),
      ),
    );
  }
}
